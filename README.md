# Navaja Barbershop — Sistema para barberias

Un sistema de gestion para barberias: turnos, ventas del dia, conversaciones con clientes y contactos. Un sistema demo hecho con Next.js.
...
## Demo en vivo
👉 https://sistema-barberia-three.vercel.app
...
- Turnos (agenda del dia por barbero)
- Conversaciones (inbox de clientes)
- Ventas (registro de cobros del dia)
- Contactos (clientes)
- Configuracion
...
2. Cloná el repo:
       ...
       git clone https://github.com/jlucasacosta/sistema-barberia.git
